            ...
            <body>
              <div class="device-container">
                ...
                <div class="device-frame">
                  <iframe src="${previewUrl}" sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin allow-downloads allow-top-navigation-by-user-activation" allow="cross-origin-isolated; webgl *; webgl2 *; webgpu *"></iframe>
                </div>
              </div>
            </body>
            </html>
                ...
                >
                  ...
                  >
                    ...
                    <iframe
                      ...
                      allow="cross-origin-isolated; webgl *; webgl2 *; webgpu *"
                    />
                  </div>
                </div>
              ) : (
